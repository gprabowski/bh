...
void gl_object::reset_api_elements(kaczka::mesh &m) {
  // allocation or reallocation
  glNamedBufferData(vbo, sizeof(kaczka::vertex_t) * m.vertices.size(),
  ...
  glVertexArrayVertexBuffer(vao, 0, vbo, 0, sizeof(kaczka::vertex_t));
